...
export const ArtCard = ({
  ...
  return (
    <ArtCardContainer>
      ...
      <TimeDiv>
        {showCart && <CartBtn onClick={addToCart}>Add to Cart</CartBtn>}
      </TimeDiv>
...
export const UpcomingAuctionCard = ({
  data,
  onClick,
  whichBid,
  textColor,
...
export const LiveAuctionCard = ({
  ...
  const { startingPrice, currentPrice, startDate, endDate, bidders, artwork } =
    data;
  const { artName, price, imageUrl, artist, likes } = artwork;
